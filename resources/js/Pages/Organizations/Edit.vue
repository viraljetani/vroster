<template>
  <div>
    ...
    <h2 class="mt-12 font-bold text-2xl">Employees</h2>
    <div class="mt-6 bg-white rounded shadow overflow-x-auto">
      <table class="w-full whitespace-no-wrap">
        ...
        <tr v-for="employee in organization.employees" :key="employee.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
          <td class="border-t">
        ...
        <tr v-if="organization.employees.length === 0">
